import{h as c,p,a as u,b as h,s as d,m as f,g as m}from"./projects-Dli9hbPg.js";import{s as n}from"./services-BBKFA7Xi.js";const o=a=>a.replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/</g,"&lt;"),g=a=>a.split(/\n\s*\n/).map(e=>`<p>${e.trim()}</p>`).join("");function r(a,e,s={}){const{aos:t="fade-up",id:i}=s;return`
