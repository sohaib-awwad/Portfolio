import{h as u,a as i,p as l,b as p,m as h,g as m}from"./projects-BZuKw93H.js";const g=e=>e==="Notion"?"chip-notion":["Full-Stack","Front-End","Back-End"].includes(e)?"chip-web-project":"chip-design-project",r=e=>e.replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/</g,"&lt;"),c=e=>e.split(/\n\s*\n/).map(s=>`<p>${s.trim()}</p>`).join("");function f(e){const s=e.chips.map(n=>`<span class="${g(n)}">${n}</span>`).join(""),a=[];return e.links.live&&a.push(`<a class="btn primary" href="${e.links.live}" target="_blank" rel="noopener">
