import{h as u,b as o,p as l,a as p,m as h,g as m}from"./projects-D0m4Kw3Y.js";/* empty css                 */const g=e=>["Full-Stack","Front-End","Back-End","Notion"].includes(e)?"chip-web-project":"chip-design-project",r=e=>e.replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/</g,"&lt;"),c=e=>e.split(/\n\s*\n/).map(s=>`<p>${s.trim()}</p>`).join("");function f(e){const s=e.chips.map(n=>`<span class="${g(n)}">${n}</span>`).join(""),a=[];return e.links.live&&a.push(`<a class="btn primary" href="${e.links.live}" target="_blank" rel="noopener">
